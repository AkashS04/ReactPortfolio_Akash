...
const Skills = () => {
  ...
  return (
    <Box sx={{ padding: {lg:"0rem 4rem",md:"0rem 3rem",sm:"0rem 2rem",xs:"0rem 2rem"} }}>
      ...
      {coreSkills.map((skills:any)=>(
         <Box
         sx={{
          width:{lg:'40%',md:'40%',sm:'80%',xs:'80%'},
           display: "flex",
           flexDirection: "column",
           backgroundColor: "#48484894",
           padding: {lg:"1rem 2rem 3rem 2rem",md:"1rem 2rem 3rem 2rem",sm:"0.8rem 1rem 1.5rem 1rem",xs:"0.8rem 0.8rem 1.5rem 0.8rem"},
           borderRadius: "1rem",
           margin: {lg:"1rem",md:"1rem",sm:"0.7rem",xs:"0.5rem"},
         }}
       >
         <Box>
           <Typography variant="h5"  sx={{color:'#e3e3e3', fontFamily: 'Raleway-Regular',fontSize:{
            lg:"1.5rem",
            md:"1rem",
            sm:"0.8rem",
            xs:"0.8rem"
         ...
         <Box sx={{ display: "flex", alignItems: "center" }}>
           ...
           <Box sx={{ minWidth: 35 }}>
             <Typography
               variant="body2"
               sx={{ color: "#d52e2e", fontFamily:'Poppins-Semibold',fontSize:{lg:'1.1rem',md:'1rem',sm:'1.2rem',xs:'0.8rem'} }}
