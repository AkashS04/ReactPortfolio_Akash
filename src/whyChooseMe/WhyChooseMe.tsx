      ...
      <Box sx={{ width: "auto" }}>
        ...
        <Box sx={{padding:{lg:'2rem 4rem',
          ...
          <Box sx={{ display: "flex",
          ...
          
              {
                Skillset.map((skills:any)=>(
                  ...
                  sx={{
                    ...
                    margin: {lg:"1rem",md:"0.5rem 1rem",sm:"0.2rem 1rem",xs:"0rem 2rem"},
              ...
              />
              <Box>
                <Typography variant='h5' align='left' sx={{fontFamily:'Raleway-Extralight',color:'#e3e3e3',fontSize:{
                  lg:'1.5rem',
                  md:'1rem',
                  sm:'0.9rem',
                  xs:'0.7rem'
                }}}>{skills.title}</Typography>
                <Typography variant='body1' align='left' sx={{fontFamily:'Poppins-Regular',color:'#e3e3e3',fontSize:{
                  lg:'1rem',
                  md:'1rem',
                  sm:'0.6rem',
                  xs:'0.6rem'
                }}}>{skills.name}</Typography>
              </Box>
            </Box>
                ))
              }
